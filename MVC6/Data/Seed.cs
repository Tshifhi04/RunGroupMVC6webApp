                ...
                if (!context.Races.Any())
                {
                    context.Races.AddRange(new List<Race>()
                    {
                        ...
                        new Race()
                        {
                            ...
                            Image = "https://www.eatthis.com/wp-content/uploads/sites/4/2020/05/running.jpg?quality=82&strip=1&resize=640%2C360",
                            Description = "This is the description of the first race",
                            RaceCategory = RaceCategory.Sprint100m,
                            AddressId = 5,
                            Address = new Address()
                            {
                                Street = "123 Main St",
                         ...
                         new Race()
                        {
                            ...
                            Image = "https://www.eatthis.com/wp-content/uploads/sites/4/2020/05/running.jpg?quality=82&strip=1&resize=640%2C360",
                            Description = "This is the description of the first race",
                            RaceCategory = RaceCategory.HalfGroundSprint,
                            AddressId = 5,
                            Address = new Address()
                            {
                                Street = "123 Main St",
                        ...
                        }, new Race()
                        {
                            ...
                            Image = "https://www.eatthis.com/wp-content/uploads/sites/4/2020/05/running.jpg?quality=82&strip=1&resize=640%2C360",
                            Description = "This is the description of the first race",
                            RaceCategory = RaceCategory.HalfMarathonSprint,
                            AddressId = 5,
                            Address = new Address()
                            {
                                Street = "123 Main St",
